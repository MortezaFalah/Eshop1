...
namespace Domain.Eshop.ViewModels.Common
{
    public class BasePagingClientSide<T>
    {
        public BasePagingClientSide()
        {
            Page = 1;
            TakeEntity = 12;
        ...
        public async Task<BasePagingClientSide<T>> Paging(IQueryable<T> queryable)
        {
